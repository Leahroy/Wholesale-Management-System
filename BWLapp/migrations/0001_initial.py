# Generated by Django 5.2 on 2025-09-28 15:02
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('customer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='BWLapp.customer')),
            ],
        ),
        migrations.CreateModel(
            name='Payment',
            fields=[
                ...
                ('order', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='BWLapp.order')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, help_text='Upload a high-quality product image.', null=True, upload_to='product_images/')),
                ('category', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='BWLapp.category')),
            ],
        ),
        migrations.CreateModel(
            name='Profile',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('package_type', models.CharField(choices=[('6pack', '6-Pack'), ('dozen', 'Dozen'), ('Carton', 'Carton'), ('bulk', 'Bulk')], help_text="e.g., '6-Pack', 'Dozen'", max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='items', to='BWLapp.order')),
                ('stock_item', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='BWLapp.stock')),
            ],
        ),
    ]
